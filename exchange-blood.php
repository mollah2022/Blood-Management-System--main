    ...
    <div class="container">
        ...
        ************************************** -->
        ...
        if(isset($_POST['sub']))
        {
            ...
            $q=$db->prepare("INSERT INTO Ex_bgroup (name,father_name,city,address,age,email,phone_num,blood_group,ex_bgroup) VALUES(:name,:father_name,:city,:address,:age,:email,:phone_num,:blood_group,:ex_bgroup)");
            ...
            $q->bindValue('ex_bgroup',$ex_bgroup);
            if($q->execute())
            {
